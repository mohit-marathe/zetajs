...
Module.jsuno.then(function(jsuno) {
    ...
    }
    {
        ...
        console.assert(v12.val === 'hä');
        const v13v = v13.val;
        console.assert(v13v.toString() === 'long');
        const v14v = v14.val;
        console.assert(v14v.get() === -123456)
        const v15v = v15.val;
        console.assert(v15v.size() === 3);
        console.assert(v15v.get(0) === 'foo');
        console.assert(v15v.get(1) === 'barr');
        console.assert(v15v.get(2) === 'bazzz');
        console.assert(v16.val === jsuno.uno.org.libreoffice.embindtest.Enum.E_2);
        const v17v = v17.val;
        console.assert(v17v.m1 === 1); //TODO: true
        console.assert(v17v.m2 === -12);
        console.assert(v17v.m3 === -1234);
        console.assert(v17v.m4 === 54321);
        console.assert(v17v.m5 === -123456);
        console.assert(v17v.m6 === 3456789012);
        console.assert(v17v.m7 === -123456789n);
        console.assert(v17v.m8 === 9876543210n);
        console.assert(v17v.m9 === -10.25);
        console.assert(v17v.m10 === 100.5);
        console.assert(v17v.m11 === 'Ö');
        console.assert(v17v.m12 === 'hä');
        console.assert(v17v.m13.toString() === 'long');
        console.assert(v17v.m14.get() === -123456);
        console.assert(v17v.m15.size() === 3);
        console.assert(v17v.m15.get(0) === 'foo');
        console.assert(v17v.m15.get(1) === 'barr');
        console.assert(v17v.m15.get(2) === 'bazzz');
        console.assert(v17v.m16 === Module.uno.org.libreoffice.embindtest.Enum.E_2);
        console.assert(v17v.m17.m === -123456);
        console.assert(v17v.m18.m1.m === 'foo');
        console.assert(v17v.m18.m2 === -123456);
        console.assert(v17v.m18.m3.get() === -123456);
        console.assert(v17v.m18.m4.m === 'barr');
        console.assert(jsuno.sameUnoObject(v17v.m19, test));
        const v18v = v18.val;
        console.assert(jsuno.sameUnoObject(v18v, test));
        v1.delete();
        v2.delete();
        v3.delete();
        v4.delete();
